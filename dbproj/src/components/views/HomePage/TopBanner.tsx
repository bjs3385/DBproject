                    ...
                    <a href="/product/list.html?cate_no=24">
                        <picture>
                            <source srcSet="//img.echosting.cafe24.com/skin/skin_ko_KR/main/img_collection1.webp"
                                    type="image/webp"/>
                            <img src="//img.echosting.cafe24.com/skin/skin_ko_KR/main/img_collection1.jpg" width="100%"
                                 height="100%" alt="banner1"/>
                        </picture>
                    </a>
                </div>
                <div className="collection-item">
                    <a href="/product/list.html?cate_no=24">
                        <picture>
                            <source srcSet="//img.echosting.cafe24.com/skin/skin_ko_KR/main/img_collection2.webp"
                                    type="image/webp"/>
                            <img src="//img.echosting.cafe24.com/skin/skin_ko_KR/main/img_collection2.jpg" width="100%"
                                 height="100%" alt="banner2"/>
                        </picture>
                    </a>
                </div>
                    ...
                    <a href="/product/list.html?cate_no=24">
                        <picture>
                            <source srcSet="//img.echosting.cafe24.com/skin/skin_ko_KR/main/img_collection3.webp"
                                    type="image/webp"/>
                            <img src="//img.echosting.cafe24.com/skin/skin_ko_KR/main/img_collection3.jpg" width="100%"
                                 height="100%" alt="banner3"/>
                        </picture>
                    </a>
                </div>
            </section>
