...
const TopBar = () => {
    return (
        <nav className="navigation">
            <button type="button" className="btnNav eNavFold"><i aria-hidden="true" className="icon icoNav"></i>네비게이션</button>
            <div className="navigation__util">
                <button type="button" className="menu btnSearch eSearch">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" className="icon" role="img">
                        <path stroke="#f5f5f5" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11 19c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8z"/>
